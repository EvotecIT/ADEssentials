function New-DHCPUtilizationTab {
    ...
    New-HTMLTab -TabName 'Utilization' {
            ...
            New-HTMLPanel -Invisible {
                ...
                New-HTMLContainer -Width '100%' {
                    New-HTMLPanel {
                        ...
                        New-HTMLText -Text "$($DHCPData.Statistics.OverallPercentageInUse)% Used" -FontSize 18pt -FontWeight bold -Alignment center -Color $(
                            if ($DHCPData.Statistics.OverallPercentageInUse -gt 90) { 'Red' }
                            elseif ($DHCPData.Statistics.OverallPercentageInUse -gt 75) { 'Orange' }
                            else { 'Green' }
                        )
                    } -Width '33%'
        ...
        if ($DHCPData.ServerPerformanceAnalysis.Count -gt 0) {
            New-HTMLSection -HeaderText "🖥️ Server Utilization Analysis" {
        ...
        New-HTMLSection -HeaderText "📈 Scope Utilization Analysis" {
